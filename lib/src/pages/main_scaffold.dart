...
class MainScaffold extends StatelessWidget {
  ...
  const MainScaffold({Key? key, this.body, this.navIndex = 0, this.navActions, this.title, this.floatingActionButton}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Provider.of<AuthService>(context).authUser == null || body == null
        ? const LoginPage()
        : Scaffold(
